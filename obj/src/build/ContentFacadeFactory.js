...
class ContentFacadeFactory extends pip_services_components_node_1.Factory {
    constructor() {
        super();
...
ContentFacadeFactory.Descriptor = new pip_services_commons_node_1.Descriptor("pip-facade-content", "factory", "default", "default", "1.0");
ContentFacadeFactory.TagsOperationsV1Descriptor = new pip_services_commons_node_1.Descriptor("pip-facade-content", "operations", "tags", "*", "1.0");
ContentFacadeFactory.QuotesOperationsV1Descriptor = new pip_services_commons_node_1.Descriptor("pip-facade-content", "operations", "quotes", "*", "1.0");
ContentFacadeFactory.ApplicationsOperationsV1Descriptor = new pip_services_commons_node_1.Descriptor("pip-facade-content", "operations", "applications", "*", "1.0");
ContentFacadeFactory.TipsOperationsV1Descriptor = new pip_services_commons_node_1.Descriptor("pip-facade-content", "operations", "tips", "*", "1.0");
ContentFacadeFactory.GuidesOperationsV1Descriptor = new pip_services_commons_node_1.Descriptor("pip-facade-content", "operations", "guides", "*", "1.0");
ContentFacadeFactory.HelpOperationsV1Descriptor = new pip_services_commons_node_1.Descriptor("pip-facade-content", "operations", "help", "*", "1.0");
ContentFacadeFactory.ImageSetsOperationsV1Descriptor = new pip_services_commons_node_1.Descriptor("pip-facade-content", "operations", "imagesets", "*", "1.0");
ContentFacadeFactory.FilesOperationsV1Descriptor = new pip_services_commons_node_1.Descriptor("pip-facade-content", "operations", "files", "*", "1.0");
ContentFacadeFactory.DashboardsOperationsV1Descriptor = new pip_services_commons_node_1.Descriptor("pip-facade-content", "operations", "dashboards", "*", "1.0");
ContentFacadeFactory.MessageTemplatesOperationsV1Descriptor = new pip_services_commons_node_1.Descriptor("pip-facade-content", "operations", "msgtemplates", "*", "1.0");
