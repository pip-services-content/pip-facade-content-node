...
class MessageTemplatesOperationsV1 extends pip_services3_facade_node_1.FacadeOperations {
    constructor() {
        super();
        this._dependencyResolver.put('msgtemplates', new pip_services3_commons_node_1.Descriptor('pip-services-msgtemplates', 'client', '*', '*', '1.0'));
    }
