...
class GuidesOperationsV1 extends pip_services3_facade_node_1.FacadeOperations {
    constructor() {
        super();
        this._dependencyResolver.put('guides', new pip_services3_commons_node_1.Descriptor('pip-services-guides', 'client', '*', '*', '1.0'));
    }
