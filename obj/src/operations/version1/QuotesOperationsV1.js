...
class QuotesOperationsV1 extends pip_services_facade_node_1.FacadeOperations {
    constructor() {
        super();
        this._dependencyResolver.put('quotes', new pip_services_commons_node_1.Descriptor('pip-services-quotes', 'client', '*', '*', '1.0'));
    }
