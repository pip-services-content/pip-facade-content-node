...
class TagsOperationsV1 extends pip_services_facade_node_1.FacadeOperations {
    constructor() {
        super();
        this._dependencyResolver.put('tags', new pip_services_commons_node_1.Descriptor('pip-services-tags', 'client', '*', '*', '1.0'));
    }
