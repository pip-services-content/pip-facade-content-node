...
class ImageSetsOperationsV1 extends pip_services3_facade_node_1.FacadeOperations {
    constructor() {
        super();
        this._dependencyResolver.put('imagesets', new pip_services3_commons_node_1.Descriptor('pip-services-imagesets', 'client', '*', '*', '1.0'));
    }
