...
class DashboardsOperationsV1 extends pip_services_facade_node_1.FacadeOperations {
    constructor() {
        super();
        this._dependencyResolver.put('dashboards', new pip_services_commons_node_1.Descriptor('pip-services-dashboards', 'client', '*', '*', '1.0'));
    }
